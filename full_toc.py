...
def run_gemma_stage(
    ...
    *,
    ...
    prompt = build_prompt(
        ...
        parsed_text=annotate_source_orders(parsed_text),
        title=title,
        max_depth=args.max_depth,
        user_prompt=args.prompt,
    )
    toc, raw_text, used_model, gemma_api_usage = request_gemma_toc(prompt=prompt, args=args, fallback_title=title)
    toc = attach_layout_metadata_and_sort(toc, parse_layout(parsed_text))
