...
DEFAULT_GEMMA_TEXT_SINGLE_MAX_CHARS = int(os.getenv("GEMMA_TEXT_SINGLE_MAX_CHARS", os.getenv("OLLAMA_TEXT_SINGLE_MAX_CHARS", "90000")))
DEFAULT_GEMMA_TEXT_CHUNK_CHARS = int(os.getenv("GEMMA_TEXT_CHUNK_CHARS", os.getenv("OLLAMA_TEXT_CHUNK_CHARS", "45000")))
