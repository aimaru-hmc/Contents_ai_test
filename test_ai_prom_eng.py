...
Attach PDF instead of the following [PDF Extracted Text] only to create a table of contents.
Page numbers are based on the [PAGE n] markers in each text block.
